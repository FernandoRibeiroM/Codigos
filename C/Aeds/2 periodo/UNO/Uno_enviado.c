...
void Criacao_Cartas(Pilha *B)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        {
            valor = j;
            retorno = cartas_baralho(B, valor, tamanho, CorY);
            if (retorno == 1)
            {
            }
            else
        ...
        tamanho = 8;
        retorno = cartas_baralho(B, Passa_vez, tamanho, CorY);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 9;
        retorno = cartas_baralho(B, Inverter, tamanho, CorY);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 2;
        retorno = cartas_baralho(B, MaisDois, tamanho, CorY);
        if (retorno == 1)
        {
        }
        else
    ...
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j <= 9; j++)
        {
            retorno = cartas_baralho(B, valor, tamanho, CorB);
            if (retorno == 1)
                ;
            else
                printf("\n\tOcorreu um erro!\n\n");
        ...
        tamanho = 8;
        retorno = cartas_baralho(B, Passa_vez, tamanho, CorB);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 9;
        retorno = cartas_baralho(B, Inverter, tamanho, CorB);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 2;
        retorno = cartas_baralho(B, MaisDois, tamanho, CorB);
        if (retorno == 1)
        {
        }
        else
    ...
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j <= 9; j++)
        {
            retorno = cartas_baralho(B, valor, tamanho, CorG);
            if (retorno == 1)
                ;
            else
                printf("\n\tOcorreu um erro!\n\n");
        ...
        tamanho = 8;
        retorno = cartas_baralho(B, Passa_vez, tamanho, CorG);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 9;
        retorno = cartas_baralho(B, Inverter, tamanho, CorG);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 2;
        retorno = cartas_baralho(B, MaisDois, tamanho, CorG);
        if (retorno == 1)
        {
        }
        else
    ...
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j <= 9; j++)
        {
            retorno = cartas_baralho(B, valor, tamanho, CorR);
            if (retorno == 1)
            {
            }
            else
        ...
        tamanho = 8;
        retorno = cartas_baralho(B, Passa_vez, tamanho, CorR);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 9;
        retorno = cartas_baralho(B, Inverter, tamanho, CorR);
        if (retorno == 1)
        {
        }
        else
            printf("\n\tOcorreu um erro!\n\n");
        tamanho = 2;
        retorno = cartas_baralho(B, MaisDois, tamanho, CorR);
        if (retorno == 1)
        {
        }
        else
    ...
    for (i = 0; i < 2; i++)
    {
        if (i == 0)
        {
            ...
            for (j = 0; j < 2; j++)
            {
                retorno = cartas_baralho(B, valor, c, CorP);
                if (retorno == 1)
                    ;
                else
                    printf("\n\tOcorreu um erro!\n\n");
        ...
        else if (i == 1)
        {
            ...
            for (j = 0; j < 2; j++)
            {
                retorno = cartas_baralho(B, valor, tamanho, CorP);
                if (retorno == 1)
                {
                }
                else
...
int cartas_baralho(Pilha *B, char Valor[], int tamanho, char *cor)
{
    if (B->topo == 0)
    {
        Carta *c;
